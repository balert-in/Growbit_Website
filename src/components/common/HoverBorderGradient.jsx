...
const HoverBorderGradient = ({ 
    ...
    const highlight = 'radial-gradient(75% 181.15942028985506% at 50% 50%, #75ccc3 0%, rgba(255, 255, 255, 0) 100%)'
    ...
    return (
        <Tag
            ...
            {...props}
        >
            <div className={`w-auto text-white z-10 bg-[#09090b] px-8 py-4 rounded-[inherit] ${className}`}>
                {children}
            </div>
            <motion.div
            ...
            />
            <div className="bg-[#09090b] absolute z-1 flex-none inset-[2px] rounded-[100px]" />
        </Tag>
    )
}
