                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="flex-1 text-center lg:text-left z-10">
                        <motion.h2
                            ...
                            viewport={{ once: true }}
                            className="text-4xl md:text-5xl font-bold text-[#0B1120] mb-6 tracking-tight"
                        >
                        ...
                        <motion.p
                            ...
                            className="text-lg text-gray-500 mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0"
                        >
                        ...
                        >
                            <motion.button
                                whileTap={{ scale: 0.98 }}
                                className="relative flex items-center gap-3 bg-gradient-to-r from-[#0B1120] to-gray-900 text-white px-7 py-4 rounded-2xl cursor-pointer group overflow-hidden transition-all duration-300 hover:shadow-lg"
                            >
                                <motion.div
