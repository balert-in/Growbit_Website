        ...
        <section className="relative bg-white pt-32 pb-20 sm:pb-24 md:pb-32 overflow-hidden">
            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    >
                        <span className="text-sm font-bold text-[#0B1120] tracking-wide uppercase">Get in Touch</span>
                    </motion.div>

                    <h1 className="text-5xl sm:text-6xl font-bold text-[#0B1120] mb-8 leading-tight tracking-tight">
                        <motion.span
                            initial={{ opacity: 0, y: 30 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.8, delay: 0.2 }}
                            className="block bg-clip-text text-transparent bg-gradient-to-b from-[#0B1120] via-[#0B1120] to-gray-500"
                        >
