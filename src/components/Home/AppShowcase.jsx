...
const AppleLogo = ({ className }) => (
  <svg className={className} viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg">
    <path strokeWidth="15" strokeLinecap="round" strokeLinejoin="round" d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/>
  </svg>
);

const GooglePlayLogo = ({ className }) => (
  <svg className={className} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
    <path strokeWidth="15" strokeLinecap="round" strokeLinejoin="round" d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z"/>
  </svg>
);
...
const AppShowcase = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      return () => {
        ...
        playBtnRef.current?.removeEventListener(
          "mouseenter",
          handlePlayBtnEnter,
        );
        playBtnRef.current?.removeEventListener(
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-16 sm:py-20 md:py-24 bg-[#09090b] overflow-hidden"
    >
      <style>{`
                @keyframes spin {
                ...
                .group:hover .animate-svg-path path {
                  animation: drawPath 0.8s ease-in-out forwards;
                  stroke: currentColor;
                }
                .animate-svg-path path {
                  fill: currentColor;
                }
            `}</style>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 sm:gap-16 lg:gap-20">
          <div className="flex-1 text-center lg:text-left z-10">
            ...
            >
              ...
              <span className="bg-gradient-to-r from-[#75ccc3] to-[#d7e48a] bg-clip-text text-transparent">
                In Your Pocket
              </span>
            </h2>
            ...
            >
              Track field tasks, monitor your team in real-time, and get instant
              updates from the ground all from the GrowBit app. Complete
              visibility, zero guesswork.
            </p>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center bg-gradient-to-br from-[#75ccc3] to-[#5ab5ad] rounded-lg group-hover:scale-110 transition-transform duration-300 shadow-md">
                  <AppleLogo className="w-4 h-4 sm:w-5 sm:h-5 text-white animate-svg-path" />
                </div>
                <div className="text-left relative z-10">
                  <div className="text-[8px] sm:text-[9px] uppercase text-gray-400 group-hover:text-[#75ccc3] transition-colors duration-300 tracking-wider">
                    Download on
                  </div>
              ...
              >
                ...
                <div className="relative z-10 w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center bg-gradient-to-br from-[#d7e48a] to-[#c4d178] rounded-lg group-hover:scale-110 transition-transform duration-300 shadow-md">
                  <GooglePlayLogo className="w-4 h-4 sm:w-5 sm:h-5 text-[#09090b] animate-svg-path ml-0.5" />
                </div>
                <div className="text-left relative z-10">
                  <div className="text-[8px] sm:text-[9px] uppercase text-gray-400 group-hover:text-[#d7e48a] transition-colors duration-300 tracking-wider">
                    Get it on
                  </div>
                  <div className="text-xs sm:text-sm font-bold leading-tight">
                    Google Play
          ...
          <div className="flex-1 relative w-full flex items-center justify-center py-8 sm:py-0">
            ...
            >
              <AnimatedRing
                className="w-[200px] sm:w-[300px] md:w-[400px] lg:w-[500px] h-[200px] sm:h-[300px] md:h-[400px] lg:h-[500px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
                delay={0}
              />
              <AnimatedRing
                className="w-[150px] sm:w-[220px] md:w-[300px] lg:w-[380px] h-[150px] sm:h-[220px] md:h-[300px] lg:h-[380px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
                delay={2}
              />
            </div>
