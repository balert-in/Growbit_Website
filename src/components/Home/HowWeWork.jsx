...
const phases = [
  {
    ...
    title: "Scope",
    description:
      "We start by understanding your goals target regions, customer segments, and what success looks like for you.",
    align: "left",
  },
  {
    id: 2,
    title: "Deploy",
    description:
      "Our verified field teams hit the ground running. We handle recruitment, training, and logistics so you don't have to.",
    align: "right",
  },
  {
    id: 3,
    title: "Track",
    description:
      "Every task is geo-tagged and monitored in real-time. You get live dashboards, instant updates, and complete visibility.",
    align: "left",
  },
  {
    id: 4,
    title: "Scale",
    description:
      "Once the model works, we scale fast. Add more agents, enter new territories, or expand scope all with performance accountability.",
    align: "right",
  },
];
...
const HowWeWork = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-16 lg:py-24 bg-[#09090b] overflow-hidden"
    >
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-14 sm:mb-20">
          ...
          <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed">
            A straight forward process that takes your requirements and turns
            them into real-world execution with tracking at every step.
          </p>
        </div>
        ...
        <div ref={containerRef} className="relative max-w-4xl mx-auto">
          <div className="absolute left-1/2 -translate-x-1/2 top-0 h-full w-[3px] hidden md:block">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, #75ccc3, #d7e48a, #75ccc3)",
                height: "0%",
              }}
            />
          </div>
          ...
          <div className="hidden md:block space-y-16 relative">
            {phases.map((item, index) => (
              ...
              >
                <div
                  className={`w-[calc(50%-2rem)] ${item.align === "right" ? "text-left" : "text-right"}`}
                >
                  <div className="relative">
                    <span
                      className={`absolute -top-8 text-8xl font-black text-gray-800/40 select-none ${item.align === "right" ? "left-0" : "right-0"}`}
                    >
                      {item.id}
                    </span>
