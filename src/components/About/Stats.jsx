                ...
                >
                    {ABOUT_DATA.stats.map((stat, index) => (
                        <motion.div
                            ...
                            className="py-12 px-6 text-center group hover:bg-gray-50/50 transition-colors duration-300"
                        >
                            <div className="text-5xl sm:text-6xl font-bold text-[#0B1120] mb-3 tracking-tight group-hover:scale-105 transition-transform duration-300">
